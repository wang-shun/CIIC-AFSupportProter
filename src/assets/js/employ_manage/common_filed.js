...
let em_arc_chooseField = {
  ...
  "c.storage_out_date":"出库日期",
  "a.created_time":"前道提交日期",
  "c.ukey_return_date":"退工原因",
  "c.ukey_return_date":"中止操作日期",
  "c.ukey_return_date":"退工单送办日期",
  "c.ukey_return_date":"退档日期",
  "c.ukey_return_date":"退工材料交付日期",
  "c.ukey_return_date":"退工单操作日期",
  "c.ukey_return_date":"退工操作员",
  "c.ukey_return_date":"档案操作员",
  "c.ukey_return_date":"退工单返回日期",
  "c.ukey_return_date":"退工单并档日期",
  "c.ukey_return_date":"暂存日期",
  "c.ukey_return_date":"退工反馈操作日期",
  "c.ukey_return_date":"退工成功日期",
  "c.ukey_return_date":"邮寄方式",
  "c.ukey_return_date":"寄信日期",
...
export {em_chooseField, em_relationship, em_print, customerInfo, batchOperate,em_resign_chooseField,em_arc_chooseField}
