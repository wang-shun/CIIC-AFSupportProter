...
<template>
  <div>
    <Form :model="formItem" :label-width="120">
      ...
      <Row style="margin: 10px 40px">
        <i-col :sm="{span: 22}" :md="{span: 12}" :lg="{span: 8}">
            <RadioGroup v-model="formItem.married">
              <Radio label="已婚未育"></Radio>
              <Radio label="已婚已育"></Radio>
            </RadioGroup>
        </i-col>
      </Row>
       <Row v-if="formItem.married=== '已婚未育'">
        <div v-for="item in meterials.menu" :key="item.materialTypeRelationId">
        <i-col :sm="{span: 12}" :md="{span: 8}" :lg="{span: 5}" >
       ...
       <Row v-if="formItem.married === '已婚已育'">
        <div v-for="item in meterials.menu" :key="item.materialTypeRelationId">
        <i-col :sm="{span: 12}" :md="{span: 8}" :lg="{span: 5}" >
      ...
      <div v-if="formItem.married === '已婚已育'">
      <Row style="margin: 10px 20px" >
        <i-col :sm="{span: 22}" :md="{span: 12}" :lg="{span: 8}">
      ...
      <Row style="margin: 10px 40px">
        <i-col :sm="{span: 22}" :md="{span: 12}" :lg="{span: 8}">
            <RadioGroup v-model="formItem.house">
              <Radio label="社区公共户"></Radio>
              <Radio label="自购房"></Radio>
            </RadioGroup>
        </i-col>
      </Row>
      <Row v-if="formItem.house === '社区公共户'">
        <div v-for="item in meterials.menu" :key="item.materialTypeRelationId">
