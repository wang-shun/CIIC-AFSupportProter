     ...
     <Row style="margin: 10px 20px">
      ...
      <Row v-if="material.educate === '其他相关辅助材料'">
        ...
        <i-col :sm="{span: 12}" :md="{span: 6}" :lg="{span: 4}" >
          <div style="margin-left: 100px" v-if="item.level === '4-4'">
            <input type="checkbox" :value="item.materialId" v-model="material.info.lev44" @change="change(material.info)" :id="item.materialId"/>
            <label :for="item.materialId">{{item.materialName}}</label>
          </div>
        </i-col>
        </div>
       ...
       <Row v-if="material.marryStatus === '再婚'">
        ...
        <i-col :sm="{span: 12}" :md="{span: 6}" :lg="{span: 4}" >
          <div style="margin-left: 100px" v-if="item.level === '6-4'">
            <input type="checkbox" :value="item.materialId" v-model="material.info.lev64" @change="change(material.info)" :id="item.materialId"/>
            <label :for="item.materialId">{{item.materialName}}</label>
          </div>
        </i-col>
        </div>
      ...
      <div v-if="material.marryStatus !== '未婚'">
        ...
        <Row v-if="material.hasfollower === '是'">
          ...
          <i-col :sm="{span: 12}" :md="{span: 6}" :lg="{span: 4}"  v-if="item.level === '7-1'">
            <div style="margin-left: 100px">
              <input type="checkbox" :value="item.materialId" v-model="material.info.lev71" @change="change(material.info)" :id="item.materialId"/>
              <label :for="item.materialId">{{item.materialName}}</label>
            </div>
          </i-col>
          </div>
        ...
        <Row v-if="material.hasfollower === '否'" >
          ...
          <i-col :sm="{span: 12}" :md="{span: 6}" :lg="{span: 4}" >
            <div style="margin-left: 100px" v-if="item.level === '7-2'">
              <input type="checkbox" :value="item.materialId" v-model="material.info.lev72" @change="change(material.info)" :id="item.materialId"/>
              <label :for="item.materialId">{{item.materialName}}</label>
            </div>
          </i-col>
          </div>
        ...
        <Row v-if="material.followMaterials === '全家'" >
          ...
          <i-col :sm="{span: 12}" :md="{span: 6}" :lg="{span: 4}" >
            <div style="margin-left: 100px" v-if="item.level === '8-3'">
              <input type="checkbox" :value="item.materialId" v-model="material.info.lev83" @change="change(material.info)" :id="item.materialId"/>
              <label :for="item.materialId">{{item.materialName}}</label>
            </div>
          </i-col>
          </div>
        ...
        <Row v-if="material.notFollowMaterials === '已是上海户籍'">
          ...
          <i-col :sm="{span: 12}" :md="{span: 6}" :lg="{span: 4}"  v-if="item.level === '9-1'">
            <div style="margin-left: 100px">
              <input type="checkbox" :value="item.materialId" v-model="material.info.lev91" @change="change(material.info)" :id="item.materialId"/>
              <label :for="item.materialId">{{item.materialName}}</label>
            </div>
          </i-col>
          </div>
        ...
        <Row v-if="material.notFollowMaterials === '不符合随迁条件'" >
          ...
          <i-col :sm="{span: 12}" :md="{span: 6}" :lg="{span: 4}" >
            <div style="margin-left: 100px" v-if="item.level === '9-2'">
              <input type="checkbox" :value="item.materialId" v-model="material.info.lev92" @change="change(material.info)" :id="item.materialId"/>
              <label :for="item.materialId">{{item.materialName}}</label>
            </div>
          </i-col>
          </div>
        ...
        <Row v-if="material.notFollowMaterials === '已是外籍'" >
          ...
          <i-col :sm="{span: 12}" :md="{span: 6}" :lg="{span: 4}" >
            <div style="margin-left: 100px" v-if="item.level === '9-3'">
              <input type="checkbox" :value="item.materialId" v-model="material.info.lev93" @change="change(material.info)" :id="item.materialId"/>
              <label :for="item.materialId">{{item.materialName}}</label>
            </div>
          </i-col>
          </div>
        ...
        <Row v-if="material.notFollowMaterials === '其他原因'" >
          ...
          <i-col :sm="{span: 12}" :md="{span: 6}" :lg="{span: 4}" >
            <div style="margin-left: 100px" v-if="item.level === '9-4'">
              <input type="checkbox" :value="item.materialId" v-model="material.info.lev94" @change="change(material.info)" :id="item.materialId"/>
              <label :for="item.materialId">{{item.materialName}}</label>
            </div>
          </i-col>
          </div>
      ...
      <Row v-if="material.addr === '社区公共户'">
        ...
        <i-col :sm="{span: 12}" :md="{span: 6}" :lg="{span: 4}"  v-if="item.level === '10-1'">
          <div style="margin-left: 100px">
            <input type="checkbox" :value="item.materialId" v-model="material.info.lev101" @change="change(material.info)" :id="item.materialId"/>
            <label :for="item.materialId">{{item.materialName}}</label>
          </div>
        </i-col>
        </div>
      ...
      <Row v-if="material.addr === '自购房'" >
        ...
        <i-col :sm="{span: 12}" :md="{span: 6}" :lg="{span: 4}" >
          <div style="margin-left: 100px" v-if="item.level === '10-2'">
            <input type="checkbox" :value="item.materialId" v-model="material.info.lev102" @change="change(material.info)" :id="item.materialId"/>
            <label :for="item.materialId">{{item.materialName}}</label>
          </div>
        </i-col>
        </div>
