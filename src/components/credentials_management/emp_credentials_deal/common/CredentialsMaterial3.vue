  ...
  <div>
    <Form :model="formItem" :label-width="120">
     ...
     <Row style="margin: 10px 20px">
      ...
      <Row style="margin: 10px 40px">
        <i-col :sm="{span: 22}" :md="{span: 12}" :lg="{span: 8}">
            <RadioGroup v-model="formItem.applyaddrchange">
              <Radio label="户籍地址变更材料"></Radio>
              <Radio label="在沪地址变更材料"></Radio>
            </RadioGroup>
        </i-col>
      </Row>
      <Row v-if="formItem.applyaddrchange === '户籍地址变更材料'">
        <div v-for="item in meterials.menu" :key="item.materialTypeRelationId">
        <i-col :sm="{span: 12}" :md="{span: 8}" :lg="{span: 5}" >
       ...
       <Row v-if="formItem.applyaddrchange === '在沪地址变更材料'">
        <div v-for="item in meterials.menu" :key="item.materialTypeRelationId">
        <i-col :sm="{span: 12}" :md="{span: 8}" :lg="{span: 5}" >
