...
<script>
    ...
    methods: {
      authorityListQuery(params){
        ...
        this.$router.push({name:'amauthority', query: {userId: userId,displayName: displayName,employeeNumber: employeeNumber,userStatus: userStatus,email: email,userType: userType}});
      },
    }
}
</script>