<template>
  <div class="smList">
    ...
    <can-edit-table refs="table3" :editIncell="true" :columns-list="columns7" :table-data="data6"
                    :saveEdit="saveEditInlineIncell" :deleteRow="deleteRowInlineIncell"></can-edit-table>
