          ...
          <Form :label-width=135>
            <Row class="mt20" type="flex" justify="start">
              <Row type="flex" justify="start">
                ...
                <Col :sm="{span:22}" :md="{span: 12}" :lg="{span: 8}">
                <FormItem label="补缴原因：">
                  <Select v-model="displayVO.repairReason" style="width: 100%;" transfer>
                    <Option v-for="item in repairReason" :value="item.key" :key="item.key">{{item.value}}</Option>
                  </Select>
                </FormItem>
                </Col>
                <Col :sm="{span:22}" :md="{span: 12}" :lg="{span: 8}">
                ...
                <FormItem label="操作提示日期">
                  <DatePicker v-model="displayVO.operationRemindDate" format="yyyy-MM-dd" placement="bottom-end" placeholder="选择日期" style="width: 100%;" transfer></DatePicker>
                </FormItem>
                </Col>
                <Col :sm="{span: 24}">
