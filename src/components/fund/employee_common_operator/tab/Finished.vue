  ...
  <div class="smList" style="margin-bottom: 56px">
    <Collapse v-model="collapseInfo">
      <Panel name="1">
        雇员日常操作
        <div slot="content">
           <search-employee @on-search="searchEmploiees" :showHandle="showHandle" sessionKey="fundDailyF" sessionKeyAdd="fundDailyFAdd"></search-employee>
        </div>
      </Panel>
    </Collapse>
