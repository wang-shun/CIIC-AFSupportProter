<template>
  <div>
    ...
    <Row class="mt20">
      ...
      <Button type="error" @click="">撤消</Button>
      </Col>
    </Row>

    <Row class="mt20">
      <Col :sm="{span:24}">
        <Table border :columns="processingColumns" :data="data.processingData"></Table>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions('processing',[EventType.PROCESSING]),
