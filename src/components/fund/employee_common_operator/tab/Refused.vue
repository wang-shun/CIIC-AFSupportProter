<template>
  <div>
    ...
    <Row class="mt20">
      <Col :sm="{span:24}">
        <Table border :columns="refusedColumns" :data="data.refusedData"></Table>
...
<script>
  ...
  export default {
    data() {
      return {
        ...
        refusedColumns: [
          ...
          {title: '发起供应商', key: 'initiateSupport', width: 150, align: 'center',
            render: (h, params) => {
              return h('div', {style: {textAlign: 'left'}}, [
                h('span', params.row.initiateSupport),
              ]);
            }
          },
          ...
          {title: '批退人', key: 'refuser', width: 150, align: 'center',
            render: (h, params) => {
              return h('div', {style: {textAlign: 'left'}}, [
                h('span', params.row.refuser),
              ]);
            }
          },
          {title: '批退时间', key: 'refuseDate', width: 200, align: 'center',
            render: (h, params) => {
              return h('div', {style: {textAlign: 'left'}}, [
    ...
    methods: {
      ...mapActions('refused',[EventType.REFUSED]),
