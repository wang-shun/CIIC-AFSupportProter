        ...
        <row>
          ...
          <Col :xs="{ span: 6, offset: 1 }" :lg="{ span: 6, offset: 0 }" class="checkBtn">
            <Form-item label="客服经理：" prop="types">
              <Input v-model="formItem.name" placeholder="周莉"></Input>
            </Form-item>
          </Col>
        </row>
        <row>
          ...
          <Col :xs="{ span: 6, offset: 1 }" :lg="{ span: 6, offset: 0 }" class="checkBtn">
            <Form-item label="雇员姓名：" v-if="!onlyNum" prop="dataTypes">
              <Input v-model="formItem.name" placeholder="戴敏"></Input>
            </Form-item>
          </Col>
          <Col :xs="{ span: 6, offset: 1 }" :lg="{ span: 6, offset: 0 }" class="checkBtn">
            <Form-item label="证件号码：">
              <Input v-model="formItem.name" placeholder="310105198505305026"></Input>
            </Form-item>
          </Col>
        </row>
        <row>
          <Col :xs="{ span: 6, offset: 1 }" :lg="{ span: 6, offset: 0 }" class="checkBtn">
            <Form-item label="款项类型：">
              <Select v-model="formItem.dataTypes" placeholder="请选择">
        ...
        <row>
          ...
          <Col :xs="{ span: 6, offset: 1 }" :lg="{ span: 6, offset: 0 }" class="checkBtn">
            <Form-item label="医疗备注：">
              ...
              <!-- <Input type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入..." v-model="formItem.note"></Input> -->
            </Form-item>
          </Col>
        </row>
        <row>
