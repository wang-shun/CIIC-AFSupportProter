<template>
  <div class="pendingTaskList">
    ...
    <div class="create">
      <Row :gutter="18">
        <Col span="1">
        <Button type="info" ref="rmb" @click="modal1 = true">审核</Button>
        <Modal
          v-model="modal1"
          title="审核对话框"
          @on-ok="ok"
        ...
        <Col span="2">
        <Button type="info" @click="modal4 = true">同步至中盈</Button>
        <Modal
          v-model="modal4"
          title="同步至中盈对话框"
          @on-ok="ok"
        ...
        <Col span="1">
        <Button type="info" @click="modal10 = true">同步至中智</Button>
        <Modal
          v-model="modal10"
          title="同步至中智对话框"
          @on-ok="ok"
        ...
        <Col span="1">
        <Button type="info" style="margin-left: 35px;" @click="modal5 = true">更新在保库</Button>
        <Modal
          v-model="modal5"
          title="更新在保库对话框"
          @on-ok="toubao"
        ...
        <Col span="1">
        <Button type="info" style="margin-left: 70px;" @click="modal6 = true">失败处理</Button>
        <Modal
          v-model="modal6"
          title="失败处理对话框"
          @on-ok="toubao"
