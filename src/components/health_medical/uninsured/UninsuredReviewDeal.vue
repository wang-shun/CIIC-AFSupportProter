  ...
  <div class="auditAcceptance">
    <Card>
      <Form :model="formItem" :label-width="120">
        <row>
          ...
          <Form-item label="就诊日期：">
            <Date-picker v-model="formItem.deliveryDate" :type="dateType" placeholder="选择月份"
                         :key="formItem.salaryIntervalType" style="width: 100%"></Date-picker>
          </Form-item>
          </Col>
          <Col :xs="{ span: 6, offset: 1 }" :lg="{ span: 6, offset: 0 }">
          <Form-item label="附件：">
          ...
          <Form-item label="住院开始日期：">
            <Date-picker v-model="formItem.deliveryDate" :type="dateType" placeholder="选择月份" :format="dateFormat"
                         :key="formItem.salaryIntervalType" style="width: 100%"></Date-picker>
          </Form-item>
          </Col>
          <Col :xs="{ span: 6, offset: 1 }" :lg="{ span: 6, offset: 0 }">
      ...
      <div class="tc">
        ...
        <router-link to="/uninsuredReview">
