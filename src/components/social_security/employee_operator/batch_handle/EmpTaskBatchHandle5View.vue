    ...
    data() {
      return {
        ...
        operatorTableOutColumns: [
          ...
          {
            title: '客户名称', width: 120, key: 'title', align: 'center',
            render: (h, params) => {
              return h('div', {style: {textAlign: 'left'}}, [
          ...
          },
          {
            ...
            render: (h, params) => {
              return h('div', [
                 h('span', this.$decode.taskCategory(params.row.taskCategory)),//params.row.taskCategory=="5"?"转出":"封存"
          ...
          {
            title: '备注', key: 'handleRemark', align: 'center', width: 260, ellipsis: true,
            render: (h, params) => {
              let self = this
              return h('div', [
                h('i-input', {
