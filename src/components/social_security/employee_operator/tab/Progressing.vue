  ...
  <div style="height: 1000px;">
    <Collapse v-model="collapseInfo">
      <Panel name="1">
        查询条件
        <div slot="content">
            <search-employee ref="searchEmployeeP" @on-search="searchEmploiees" :showHandle="showHandle" sessionKey="socialDailyP" sessionKeyAdd="socialDailyPAdd"></search-employee>
        </div>
      </Panel>
    </Collapse>
            ...
            render: (h, params) => {
              return h('div', [
                h('Button', {
                  ...
                  on: {
                    click: () => {
                      sessionData.setJsonDataToSession('employeeCommonOperator.Progressing.operatorSearchData', this.operatorSearchData);
                      sessionData.setJsonDataToSession('employeeCommonOperator.Progressing.employeeResultPageData', this.employeeResultPageData);
