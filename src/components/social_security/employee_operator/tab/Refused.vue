  ...
  <div style="height: 1000px;">
    <Collapse v-model="collapseInfo">
      <Panel name="1">
        查询条件
        <div slot="content">
          <search-employee ref="searchEmployeeR" @on-search="searchEmploiees" :showHandle="showHandle" sessionKey="socialDailyR" sessionKeyAdd="socialDailyRAdd"></search-employee>
        </div>
      </Panel>
    </Collapse>
            ...
            render: (h, params) => {
              return h('div', [
                h('Button', {
                  ...
                  on: {
                    click: () => {
                      sessionData.setJsonDataToSession('employeeCommonOperator.Refused.operatorSearchData', this.operatorSearchData);
                      sessionData.setJsonDataToSession('employeeCommonOperator.Refused.employeeResultPageData', this.employeeResultPageData);
