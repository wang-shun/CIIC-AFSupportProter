  ...
  <div>
    ...
    <Row class="mt20">
      <Col :xs="{span: 24}" :lg="{span: 24}">
        <Table border :columns="employeeResultColumns" :data="refusehandle.employeeResultData"></Table>
    ...
    <Modal
      ...
      @on-ok="ok"
      @on-cancel="cancel">
      <customer-modal :customerData="refusehandle.customerData"></customer-modal>
    </Modal>
    ...
    <Modal
      ...
      @on-ok="ok"
      @on-cancel="cancel">
      <company-account-search-modal :sSocialSecurityTypeData="refusehandle.sSocialSecurityTypeData"></company-account-search-modal>
    </Modal>
  </div>
</template>
<script>
  ...
  export default {
    ...
    mounted() {
      this.setRefuseHandle()
    },
    computed: {
      ...mapGetters('refuseHandle',[
        'refusehandle'
      ])
    },
    methods: {
      ...mapActions('refuseHandle',{
        setRefuseHandle: eventType.REFUSEHANDLETYPE
      }),
