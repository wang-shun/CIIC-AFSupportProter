    ...
    <Form>
      ...
      <Row>
        <Col :xs="{span: 24}" :lg="{span: 24}">
          <Table border :columns="employeeResultColumns" :data="progressing.employeeResultData" ref="employeeSocialSecurityData"></Table>
      ...
      <Modal
        ...
        @on-ok="ok"
        @on-cancel="cancel">
        <customer-modal :customerData="progressing.customerData"></customer-modal>
      </Modal>
      ...
      <Modal
        ...
        @on-ok="ok"
        @on-cancel="cancel">
        <company-account-search-modal :sSocialSecurityTypeData="progressing.sSocialSecurityTypeData"></company-account-search-modal>
      </Modal>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters('Progressing', [
        'progressing'
      ])
    },
    methods: {
      ...mapActions('Progressing', {
        setNoProgress: eventType.PROGRESSINGTYPE
      }),
