        ...
        operatorListColumns: [
          {title: '汇缴类型', key: 'payType', align: 'center',
            render: (h, params) => {
              return h('div', {style: {textAlign: 'left'}}, [
                h('Select', {props: {value: params.row.payType, disabled: params.row.disabled}},
                  [
          ...
          {title: '客户汇缴月', key: 'customerPayMonth', align: 'center',
            render: (h, params) => {
              return h('div', [
                h('i-input', {
                  props: {value: params.row.customerPayMonth, disabled: params.row.disabled},
          ...
          {title: '比例', key: 'percent', align: 'center',
            render: (h, params) => {
              return h('div', [
                h('i-input', {
                  props: {value: params.row.percent, disabled: params.row.disabled},
                }, params.row.percent)
              ]);
            }
          },
          {title: '金额', key: 'price', align: 'center',
            render: (h, params) => {
              return h('div', [
                h('i-input', {
                  props: {value: params.row.price, disabled: params.row.disabled},
                }, params.row.price)
              ]);
            }
          },
